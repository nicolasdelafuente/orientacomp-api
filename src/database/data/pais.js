const paises = [
  ...
  {
    nombre: 'RepúblicaDemocráticadelCongo',
    nacionalidad: 'Congoleña',
    iso: 'COD',
    created_at: new Date(),
    updated_at: new Date(),
