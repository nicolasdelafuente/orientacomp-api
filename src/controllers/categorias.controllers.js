...
/**
 * Controlador para manejar operaciones relacionadas con Categorias.
 ...
 * @function createItem
 * @param {Object} req - Objeto de solicitud de Express con los datos de la Categoria.
 * @param {Object} res - Objeto de respuesta de Express.
 ...
 * @function updateItem
 * @param {Object} req - Objeto de solicitud de Express con el parámetro 'id' y los datos de la Categroia a actualizar.
 * @param {Object} res - Objeto de respuesta de Express.
...
/**
 * Eliminar una Categoria por su ID (marcándola como eliminada).
 * @function deleteItem
 * @param {Object} req - Objeto de solicitud de Express con el parámetro 'id'.
 * @param {Object} res - Objeto de respuesta de Express.
...
const deleteItem = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: `Categoria item deleted successfully` });
    } catch (e) {
...
/**
 * Restaurar una Categoria previamente eliminada por su ID.
...
const restoreItem = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: `Categoria item restored successfully` });
    } catch (e) {
 ...
 * @param {Number} id - ID de la Categoria a buscar.
 * @param {Boolean} deleted - Indica si la Categoria está eliminada.
 * @returns {Object} - Categoria encontrado o null si no se encuentra.
 * @throws {Error} - Si hay un error al buscar el Categoria.
 */
