...
const validatorGetItem = [
    check("id")
        .exists().withMessage('El ID categoria es obligatorio')
        .notEmpty().withMessage('El ID categoria no puede estar vacío')
        .isInt().withMessage('El ID categoria debe ser un número entero'),
